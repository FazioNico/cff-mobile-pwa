   ...
   "data": {
     "footer-list": { // <= namespace for module/component translations
       "contact": {
         "title": 'Kontakt',
         "data": `
            <p>Haben Sie Fragen? Wir helfen Ihnen gerne. Bitte lesen Sie auch unsere Erklärung zum <a href="http://www.sbb.ch/de/meta/legallines/datenschutz.html">Datenschutz</a>.</p>         `,
       },
       "infoTraffic": {
         "title": "Bahnverkehrsinformationen",
         "data": `
